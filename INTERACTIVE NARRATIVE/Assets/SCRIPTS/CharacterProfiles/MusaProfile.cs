...
public class MusaProfile : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private string displayText = "MUSA:" +
        "- Superstar soccer player" +
        "- Xola’s ex-boyfriend" +
        "- Popular figure at PN High. " +
        "- Troubled past and violent;" +
        "- Has a volatile temper.";  // Text to display
