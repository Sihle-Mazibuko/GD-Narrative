...
public class CharleneProfile : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private string displayText = "CHARLENE:" +
        "- Student council president" +
        "- Rival prom queen nominee;" +
        "- Will stop at nothing to claim the crown." +
        "- Ambitious; sly; has cutthroat tactics.";  // Text to display
