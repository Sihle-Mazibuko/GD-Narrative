...
public class PrincipalProfile : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private string displayText = "MR CARTER:" +
        "School Principal" +
        "- Strict and no-nonsensical " +
        "- Tough disciplinary measures & adherence to the rules." +
        "- Very private about his life outside school borders";  // Text to display
