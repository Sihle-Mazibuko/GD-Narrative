...
public class LindaProfile : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private string displayText = "LINDA:" +
        "- Xola's jealous best friend since Grade 2" +
        "- Fellow prom queen nominee" +
        "- Harbours resentment towards Xola for ‘always stealing the spotlight’." +
        "- Jealous; desperate for attention.";  // Text to display
